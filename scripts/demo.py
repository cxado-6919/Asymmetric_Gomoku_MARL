...
# --- 경로 수정 ---
# config_path를 프로젝트 루트의 'configs' 폴더로 지정
@hydra.main(version_base=None, config_path="../configs", config_name="demo_config")
def main(cfg: DictConfig):
    ...
    window.setWindowTitle("Gomoku Demo (Asymmetric_Gomoku_MARL)")
